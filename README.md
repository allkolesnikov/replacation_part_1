...
### 1 Скриншот 
На скриншоте статус службы MySQL на сервере Master. Служба находится в активном состоянии и готова к работе.

![Replication](Images/status_mysql_1.png)

### 2 Скриншот
На скриншоте статус службы MySQL на сервере Slave. Служба успешно запущена для работы репликации.
